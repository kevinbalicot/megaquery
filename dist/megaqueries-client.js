...
var Requester = function (_EventEmitter) {
    ...
    _createClass(Requester, [{
        ...
        value: function remove(collection, selector) {
            ...
            var query = { id: id, collection: collection, selector: selector, options: options, type: type };
        ...
        value: function distinct(collection, field, params) {
            ...
            var type = 'distinct';
            var id = collection + '.' + type + '.' + field + '.' + JSON.stringify(params) + '.' + JSON.stringify(options);
            var query = { id: id, collection: collection, field: field, params: params, options: options, type: type };
